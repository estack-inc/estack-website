...
export default function PrivacyPolicyPage() {
  return (
    <>
      <PageHeader title="プライバシーポリシー" subtitle="Privacy Policy" />

      <section className="py-12 md:py-20">
        <div className="mx-auto max-w-3xl px-5 md:px-8 prose prose-sm md:prose-base max-w-none">
          ...
          <p className="font-semibold mb-2">事業での利用</p>
