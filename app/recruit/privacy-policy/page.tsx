    ...
    <>
      ...
      <section className="py-12 md:py-16">
        <div className="mx-auto max-w-3xl px-5 md:px-8">
          ...
          <ul className="list-disc list-inside text-base text-zinc-700 leading-loose mb-6 space-y-1">
            <li>労務管理を行う目的</li>
            <li>保険業務を行う目的</li>
            <li>緊急時の連絡を行う目的</li>
          ...
          <p className="font-semibold mb-2 text-base text-zinc-700">(2) 採用活動での利用</p>
          ...
          <ol className="list-decimal list-inside text-base text-zinc-700 leading-loose mb-10 space-y-1">
          ...
          <ol className="list-decimal list-inside text-base text-zinc-700 leading-loose mb-3 space-y-1">
          ...
          <div className="my-6 text-base text-zinc-700 space-y-1">
            <p>
          ...
          <p className="text-base text-zinc-700 leading-loose">
